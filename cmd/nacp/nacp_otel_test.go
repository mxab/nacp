...
func info(msg string, attrs ...attribute.KeyValue) logtest.Record {

	return message(log.SeverityInfo, msg, attrs...)
}
func debug(msg string, attrs ...attribute.KeyValue) logtest.Record {

	return message(log.SeverityDebug, msg, attrs...)
}
func message(level log.Severity, msg string, attrs ...attribute.KeyValue) logtest.Record {
...
func s(key, value string) attribute.KeyValue {
	return attribute.String(key, value)
}
func n(key string, value int) attribute.KeyValue {
