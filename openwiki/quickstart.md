...
- **Historical progression audit** — source anchor: `.git/`; the recorded prior `gitHead` `a00f1a12089da641969b0c3be8217010d0a57175` is unavailable in this shallow checkout, so a source-backed range history cannot be reconstructed here.
